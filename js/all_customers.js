...
3 → Edit customer function - store its ID to local storage and go to edit customer page
4 → Filter table method - filters and searchbar logic
5 → Add eventListeners to the input fields and load the customers
*/
...
const loadCustomers = async () => {
    ...
    for (const customer of customerData) {
        ...
        row.innerHTML = `
            ...
            <td><button class="btn btn-outline-primary" onclick="editCustomer(${customer.id})">edit</button></td>`;
...
// 5 --------------------------- Add event listeners to the search input and filter checkboxes ---------------------
